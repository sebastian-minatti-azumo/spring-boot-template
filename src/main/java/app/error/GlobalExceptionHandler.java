...
import app.error.dto.ExceptionResponse;
import app.error.exception.DuplicateUserException;
import app.error.exception.NotFoundException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     * 409.
     */
    @ExceptionHandler({IllegalArgumentException.class, IllegalStateException.class, DuplicateUserException.class})
